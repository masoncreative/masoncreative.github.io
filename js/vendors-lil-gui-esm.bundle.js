/*! For license information please see lil-gui-esm.bundle.js.LICENSE.txt */
"use strict";
      ...
      const l = {
        ...
        a = {
          ...
          fromHexString(t, i, e = 1) {
            const n = o.fromHexString(t);
            i[0] = (n >> 16 & 255) / 255 * e, i[1] = (n >> 8 & 255) / 255 * e, i[2] = (255 & n) / 255 * e
          },
          toHexString: ([t, i, e], n = 1) => o.toHexString(t * (n = 255 / n) << 16 ^ i * n << 8 ^ e * n << 0)
        },
        h = {
          isPrimitive: !1,
          match: t => Object(t) === t,
      ...
      class p extends n {
        ...
        _initInput() {
          ...
          const o = t => {
              if (l) {
                const n = t.clientX - i,
                  s = t.clientY - e;
                Math.abs(s) > 5 ? (t.preventDefault(), this.$input.blur(), l = !1, this._setDraggingStyle(!0, "vertical")) : Math.abs(n) > 5 && a()
              }
              if (!l) {
                const i = t.clientY - n;
                r -= i * this._step * this._arrowKeyMultiplier(t), s + r > this._max ? r = this._max - s : s + r < this._min && (r = this._min - s), this._snapClampSetValue(s + r)
              }
              n = t.clientY
            },
            a = () => {
          ...
          this.$input.addEventListener("input", (() => {
            ...
            i = t.clientX, e = n = t.clientY, l = !0, s = this.getValue(), r = 0, window.addEventListener("mousemove", o), window.addEventListener("mouseup", a)
        ...
        _initSlider() {
          ...
          const t = t => {
              ...
              let e = (n = t, s = i.left, r = i.right, l = this._min, (n - s) / (r - s) * (this._max - l) + l);
              var n, s, r, l;
          ...
          this.$slider.addEventListener("mousedown", (n => {
            ...
            t.touches.length > 1 || (this._hasScrollBar ? (n = t.touches[0].clientX, s = t.touches[0].clientY, r = !0) : l(t), window.addEventListener("touchmove", o, {
              passive: !1
      ...
      class b {
        constructor({
          ...
          if (this.parent = t, this.root = t ? t.root : this, this.children = [], this.controllers = [], this.folders = [], this._closed = !1, this._hidden = !1, this.domElement = document.createElement("div"), this.domElement.classList.add("lil-gui"), this.$title = document.createElement("div"), this.$title.classList.add("title"), this.$title.setAttribute("role", "button"), this.$title.setAttribute("aria-expanded", !0), this.$title.setAttribute("tabindex", 0), this.$title.addEventListener("click", (() => this.openAnimated(this._closed))), this.$title.addEventListener("keydown", (t => {
              ...
              passive: !0
            }), this.$children = document.createElement("div"), this.$children.classList.add("children"), this.domElement.appendChild(this.$title), this.domElement.appendChild(this.$children), this.title(s), l && this.domElement.classList.add("allow-touch-styles"), this.parent) return this.parent.children.push(this), this.parent.folders.push(this), void this.parent.$children.appendChild(this.domElement);
          this.domElement.classList.add("root"), !v && r && (function (t) {
          ...
          }(), v = !0), e ? e.appendChild(this.domElement) : i && (this.domElement.classList.add("autoPlace"), document.body.appendChild(this.domElement)), n && this.domElement.style.setProperty("--width", n + "px"), this.domElement.addEventListener("keydown", (t => t.stopPropagation())), this.domElement.addEventListener("keyup", (t => t.stopPropagation()))
        }
        add(t, i, e, n, r) {
          if (Object(e) === e) return new g(this, t, i, e);
          const l = t[i];
          switch (typeof l) {
            case "number":
              return new p(this, t, i, e, n, r);
            case "boolean":
              return new s(this, t, i);
            case "string":
              return new m(this, t, i);
            case "function":
        ...
        load(t, i = !0) {
          return t.controllers && this.controllers.forEach((i => {
            i instanceof u || i._name in t.controllers && i.load(t.controllers[i._name])
...
//# sourceMappingURL=lil-gui-esm.bundle.js.map
